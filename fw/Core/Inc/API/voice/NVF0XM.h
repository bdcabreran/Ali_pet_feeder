...
#define NV04_SHUTDOWN_GPIO					GPIOB
#define NV04_SHUTDOWN_PIN					GPIO_PIN_5

#define	NV04_RECORDING_PRESS_TIME_MS 1000		
#define	NV04_PLAY_PRESS_TIME_MS	     300		
#define NV04_DELETE_PRESS_TIME_MS    300
